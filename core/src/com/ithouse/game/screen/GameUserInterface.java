...
import com.ithouse.game.entity.TowerFactory;
import com.ithouse.game.entity.tower.ArrowTower;
import com.ithouse.game.entity.tower.DirtTower;
import com.ithouse.game.entity.tower.EggTower;
import com.ithouse.game.screen.render.TowerRangeRenderer;
import com.ithouse.game.td.Config;
import com.ithouse.game.td.GDSprite;
import com.ithouse.game.td.SpriteManager;
import com.ithouse.game.td.helper.FontHelper;
import com.ithouse.game.td.helper.TimeHelper;
...
public class GameUserInterface {
    ...
    private void initializeBuildTowerButtons() {
        ...
        GDSprite dirtTower = spriteManager.getTower(TowerFactory.TowerType.Dirt_Tower);
        GDSprite arrowTower = spriteManager.getTower(TowerFactory.TowerType.Arrow_Tower);
        GDSprite eggTower = spriteManager.getTower(TowerFactory.TowerType.Egg_Tower);
        GDSprite potionTower = spriteManager.getTower(TowerFactory.TowerType.Potion_Tower);
        GDSprite currencyTower = spriteManager.getTower(TowerFactory.TowerType.Currency_Tower);
...
//		} 
    ...
    public void setTowerToBuild(Tower towerToBuild, TowerFactory.TowerType towerType) {
    ...
    public void setGhostTower(TowerFactory.TowerType towerType) {
        if (towerType != null)
