...
import com.ithouse.game.input.LvlSelectInputProcessor;
...
public class LvlSelectScreen extends GDScreen {
    ...
    public LvlSelectScreen(UnrealDefence unrealDefence) {
        ...
        initializeFont();
        initializeButtons();
        this.inputProcessor = new LvlSelectInputProcessor(unrealDefence, this);
    }
