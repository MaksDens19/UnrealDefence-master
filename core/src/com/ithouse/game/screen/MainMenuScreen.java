...
import com.ithouse.game.input.MenuInputProcessor;
...
public class MainMenuScreen extends GDScreen {
    ...
    public MainMenuScreen(UnrealDefence unrealDefence) {
        ...
        initializeButtons();
        this.inputProcessor = new MenuInputProcessor(unrealDefence, this);
    ...
    private void initializeButtons() {
        ...
        startGameBtn.setPosition(150, 400);
        startGameBtn.setSize(BUTTONS_WIDTH, BUTTONS_HEIGHT);

        settingsBtn = spriteManager.getSprite("settings_button");
        settingsBtn.setPosition(150, 500);
        settingsBtn.setSize(BUTTONS_WIDTH, BUTTONS_HEIGHT);

        aboutBtn = spriteManager.getSprite("about_button");
        aboutBtn.setPosition(150, 600);
        aboutBtn.setSize(BUTTONS_WIDTH, BUTTONS_HEIGHT);

        exitBtn = spriteManager.getSprite("exit_button");
        exitBtn.setPosition(150, 700);
        exitBtn.setSize(BUTTONS_WIDTH, BUTTONS_HEIGHT);
