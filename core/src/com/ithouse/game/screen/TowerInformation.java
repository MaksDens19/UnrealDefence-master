...
//        Texture tex = new Texture(Gdx.files.internal("assets/img/info_bg.png"));
        Texture tex = new Texture(Gdx.files.internal("info_bg.png"));
...
//        Texture upgrade = new Texture(Gdx.files.internal("assets/img/upgrade_button.png"));
        Texture upgrade = new Texture(Gdx.files.internal("upgrade_button.png"));
...
//        Texture sell = new Texture(Gdx.files.internal("assets/img/sell_button.png"));
        Texture sell = new Texture(Gdx.files.internal("sell_button.png"));
...
//        Texture iceArrow = new Texture(Gdx.files.internal("assets/img/upgrade_to_iceArrow.png"));
        ...
        Texture cEgg = new Texture(Gdx.files.internal("upgrade_to_cegg.png"));
        Texture slime = new Texture(Gdx.files.internal("upgrade_to_slime.png"));
        Texture wood = new Texture(Gdx.files.internal("upgrade_to_wood.png"));
        Texture sand = new Texture(Gdx.files.internal("upgrade_to_sand.png"));
        Texture fireArrow = new Texture(Gdx.files.internal("upgrade_to_fireArrow.png"));
        Texture iceArrow = new Texture(Gdx.files.internal("upgrade_to_iceArrow.png"));
