...
import com.ithouse.game.entity.TextureFactory;
import com.ithouse.game.entity.Tile;
...
public class SpriteManager {
    ...
    private void initializeHighlightTile() {
        Texture highlight = new Texture(Gdx.files.internal("tile_highlight.png"));
//        Texture highlight = new Texture(Gdx.files.internal("assets/img/tile_highlight.png"));
    ...
    public GDSprite getTower(TowerFactory.TowerType type) {
        return createSprite(type.toString());
    }

    public GDSprite getEnemy(Enemy.EnemyType type) {
        return createSpriteTile(type.toString());
    }

    public GDSprite getTile(Tile.TileType type) {
        return createSpriteTile(type.toString());
    }

    public GDSprite getProjectile(Projectile.ProjectileType type) {
